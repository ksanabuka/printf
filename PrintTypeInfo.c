...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/20 08:48:25 by obuksha           #+#    #+#             */
/*   Updated: 2019/06/20 08:48:28 by obuksha          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int print_type_info_chars_count(const struct pt_inf *info)
{
    ...
    res += info->type == PT_CHAR ? 1 : ft_strlen(info->value_str);
    return res;
}
    ...
    if (info->sign)
{
    ...
    if (info->type == PT_CHAR && info->value_str[0] == 0)
{
        write(1, "^@", 2);
    }
